<?php
	...
	function registro()
	{
		...
		$salida.="<table>
                    ...
                    <tr>
                        ...
                        <td class='etqf'>N&uacute;mero ext-int:</td><td><input name='noext' id='noext' class='impTextReg' type='text' maxlength='10'></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan=4><br><center><label class='text azulTxt'> El registro se ha desactivado </label></center></td>
                    </tr>";
	...
	function ingTicket()
	{
	   /* $salida.="<div id='face'>
                    <table>
                        <tr>
                            <td class='linkButon'>Siguenos:</td>                    
		...
		$salida.="<br>";
                ...
                $salida.="<br><label class='azulTxt'>Estimado participante: El REGISTRO de Tickets se ha DESACTIVADO. Por favor, dirijase a PACCAR Mexico para preguntas y asistencia</label><br><br><br>";
    ...
    function myInfo()
    {
        ...
        {
            $s="<center><form id='info' name='info'><table>
                    <tr>
...
$idPart=$_SESSION['id_part'];
 ...
 {      
  ...
  }elseif (($n==0) && ($sn==1)) 
  {
   ...
   $salida.="<table><tr>";
   $salida.="<td><label class='azulTxt'>Estimado Participante: El CANJE de Premios ha sido DESACTIVADO. Por favor, dirijase a PACCAR Mexico para preguntas y asistencia. </label></td>";
